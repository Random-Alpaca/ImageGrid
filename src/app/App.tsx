                      ...
                      >
                        ...
                        >
                          <div
                            className="absolute"
                            style={{
                              top: isExpanded ? '0px' : `-${EXPAND}px`,
                              right: isExpanded && expandEdges.right ? '0px' : `-${EXPAND}px`,
                              bottom: isExpanded ? '0px' : `-${EXPAND}px`,
                              left: isExpanded && expandEdges.left ? '0px' : `-${EXPAND}px`,
                              transition: 'top 0.35s cubic-bezier(0.2,0.8,0.2,1), right 0.35s cubic-bezier(0.2,0.8,0.2,1), bottom 0.35s cubic-bezier(0.2,0.8,0.2,1), left 0.35s cubic-bezier(0.2,0.8,0.2,1)',
                            }}
                          >
                            <motion.img
